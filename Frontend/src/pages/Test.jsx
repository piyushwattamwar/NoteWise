                  ...
                  <div className="space-y-2">
                    {q.options.map((opt, oIdx) => {
                      ...
                      return (
                       <label
  key={oIdx}
  className={`flex items-center gap-3 px-4 py-2 rounded-md w-full text-sm font-medium cursor-pointer
    ${score !== null
      ? isCorrect
        ? "bg-green-100 text-green-900 border border-green-400"
        : isSelected
        ? "bg-red-100 text-red-800 border border-red-400"
        : "bg-white dark:bg-gray-700 text-black dark:text-white border border-gray-300"
      : "bg-white dark:bg-gray-700 text-black dark:text-white border border-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"}
  `}
>
  <input
    type="radio"
